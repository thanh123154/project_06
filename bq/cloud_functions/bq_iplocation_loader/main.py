...
def trigger_bigquery_load(event, context):
    ...
    Calls bq_iplocation_loader function.
    """
    return bq_iplocation_loader(event, context)


def bq_iplocation_loader(event, context):
    """
...
if __name__ == "__main__":
    ...
    test_event = {
        ...
        "name": "exports/iplocation/test.jsonl",
    ...
    result = bq_iplocation_loader(test_event, test_context)
